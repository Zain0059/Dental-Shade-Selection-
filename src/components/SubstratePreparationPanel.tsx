      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3.5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-neutral-600 flex items-center justify-between">
              <span>Stump / Prep Die Shade (ND System):</span>
              <span className="font-mono text-teal-600 font-bold">{substrate.prepShade}</span>
            </label>
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center p-1.5 rounded-lg border text-center transition ${
                      isSelected
                        ? "bg-neutral-100 border-teal-600 ring-2 ring-teal-600/40 shadow-sm"
                  ...
                  >
                    ...
                    />
                    <span className="text-[10px] font-mono font-bold text-neutral-800">{nd}</span>
                  </button>
                );
              })}
            </div>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-neutral-600">Restoration Type:</label>
            <select
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-neutral-600">Ceramic Material Choice:</label>
            <select
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between text-xs">
              <span className="font-semibold text-neutral-600">Restoration Thickness:</span>
              <span className="font-mono font-bold text-teal-600">{substrate.thicknessMm.toFixed(1)} mm</span>
            </div>
            <input
              type="range"
              min="0.3"
        ...
        <div className="bg-neutral-100 border border-neutral-300 rounded-xl p-4 flex flex-col justify-between gap-3">
          <div className="space-y-3">
            ...
            <div className="bg-white p-3 rounded-lg border border-neutral-200 space-y-1">
              <div className="text-[10px] text-neutral-500 uppercase font-mono">Recommended Ingot &amp; Opacity:</div>
              <div className="text-sm font-bold text-neutral-900 font-mono text-teal-700">
          ...
          <div className="pt-2 border-t border-neutral-300/60 text-[11px] text-neutral-500 font-mono flex items-center justify-between">
